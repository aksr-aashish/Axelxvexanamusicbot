...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Vexana_updates")
                await self.one.join_chat("vexanaupdates")
                await self.one.join_chat("vexana_Support")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Vexana_updates")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Vexana_updates")
